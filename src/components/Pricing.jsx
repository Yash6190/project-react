...
export default function Pricing() {
  return (
    <div className="w-11/12 m-auto md:w-10/12 py-20">
      <p className="text-center">Simple Pricing</p>
      ...
      <p className="text-center lg:w-1/2 m-auto">
        At Fitness Center, we believe in making fitness affordable. Enjoy
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 py-20 gap-10">
        <div>
          <div className="border py-8 px-8 border-black">
            ...
            <p className="py-4">
              <span className="font-bold text-3xl">₹400</span> per month
            </p>
        ...
        <div>
          <div className="border py-8 px-8 border-black">
            ...
            <p className="py-4">
              <span className="font-bold text-3xl">₹600</span> per month
            </p>
            <button className="bg-black text-white p6y-2 rounded-full w-full hover:opacity-70">
              Get Started
            </button>
          </div>
          <div>
        ...
        <div>
          <div className="border py-8 px-8 border-black">
            ...
            <p className="py-4">
              <span className="font-bold text-3xl">₹1000</span> per month
            </p>
            <button className="bg-black text-white py-2 rounded-full w-full hover:opacity-70">
              Get Started
            </button>
